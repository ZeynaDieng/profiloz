      ...
      <div class="grid grid-cols-12 gap-6">
        ...
        <aside class="col-span-4 space-y-6">
          ...
          <section v-if="hasLanguages">
            <h2 class="text-xs font-bold uppercase tracking-wider text-teal-800 border-b border-teal-100 pb-1 mb-4">Langues</h2>
          ...
          <section v-if="hasInterests">
            <h2 class="text-xs font-bold uppercase tracking-wider text-teal-800 border-b border-teal-100 pb-1 mb-4">Centres d'intérêt</h2>
