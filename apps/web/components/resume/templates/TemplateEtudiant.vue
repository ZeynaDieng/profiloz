        ...
        <div v-if="hasSkills">
          ...
          <ul class="space-y-1.5">
            <li
              ...
              :key="i"
              class="text-[8.5pt] text-[#374151] flex items-start justify-between gap-2"
            >
              <div class="flex items-start gap-1.5 min-w-0 flex-1">
                ...
                />
                <span class="font-semibold break-words leading-tight">{{ skill.name }}</span>
              </div>
              <span v-if="formatSkillLevel(skill.level)" class="text-[7.5pt] text-[#64748b] shrink-0 mt-0.5">
