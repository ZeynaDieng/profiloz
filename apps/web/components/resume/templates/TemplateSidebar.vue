        ...
        <div class="grid grid-cols-[1fr_160px] gap-10 min-h-full">
            ...
            <main>
                ...
                <section v-if="hasExperiences" class="mb-8">
                    ...
                    <div v-for="(exp, i) in snapshot.experiences" :key="i" class="mb-6 pl-4 relative"
                        :style="{ borderLeft: `1.5px solid ${accent}25` }">
                        <span class="absolute -left-[4px] top-[7px] w-2 h-2 rounded-full bg-white border-2"
                ...
                <section v-if="hasEducations">
                    ...
                    <div v-for="(edu, i) in snapshot.educations" :key="i" class="mb-3 pl-4"
