...
<template>
  ...
  >
    <div class="max-w-container-max mx-auto px-margin-mobile md:px-margin-tablet xl:px-margin-desktop overflow-hidden">
      <ul class="reassurance-stats grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-gutter pb-8 md:pb-10 mb-8 md:mb-10 border-b border-outline-variant/15">
      ...
      <div class="landing-section-header text-center !pt-0">
        ...
        <p class="text-on-surface-variant text-sm max-w-2xl mx-auto">
