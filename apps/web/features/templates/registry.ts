...
export const TEMPLATE_REGISTRY: TemplateDefinition[] = [
  ...
  { slug: 'MODERNE', name: 'Moderne', category: 'Creative', previewUrl: '/templates/moderne.svg', supportedSections: ['summary', 'experience', 'skills'] },
  { slug: 'DEVELOPPEUR', name: 'Développeur', category: 'Technical', previewUrl: '/templates/developpeur.svg', supportedSections: ['skills', 'experience'] },
  { slug: 'COMMERCIAL', name: 'Commercial', category: 'Sales', previewUrl: '/templates/commercial.svg', supportedSections: ['experience', 'skills'] },
  { slug: 'MANAGER', name: 'Manager', category: 'Executive', previewUrl: '/templates/manager.svg', supportedSections: ['summary', 'experience'] },
  { slug: 'INTERNATIONAL', name: 'International', category: 'Global', previewUrl: '/templates/international.svg', supportedSections: ['languages', 'experience'] },
  ...
  { slug: 'CREATIF', name: 'Créatif', category: 'Artistic', previewUrl: '/templates/creatif.svg', supportedSections: ['skills', 'interests'] },
